...
def get_time_based_welcome_message() -> str:
    ...
    default_messages = [
        ...
        "안녕하세요 어르신! 하루입니다. 전화 주셔서 반가워요.",
        "어르신 안녕하세요. 하루에요. 오늘은 어때요?",
        "안녕하세요, 기분 좋은 하루 보내고 계신가요?",
        "안녕하세요 어르신! 저 하루예요. 오늘 하루 어떠세요?",
        "어르신 안녕하세요. 하루입니다. 오늘도 화이팅이에요!",
        "안녕하세요, 기쁘게 전화 주셔서 감사해요.",
        "안녕하세요 어르신! 하루에요. 오늘도 힘내세요.",
        "어르신 안녕하세요. 저 하루입니다. 오늘 하루는 어떠셨어요?",
        "안녕하세요, 건강하게 지내고 계신가요?",
        "안녕하세요 어르신! 하루에요. 항상 건강하시길 바라요.",
        "어르신 안녕하세요. 오늘도 기운차게 보내세요.",
        "안녕하세요, 오늘 하루 어떠셨나요?",
        "안녕하세요 어르신! 하루입니다. 오늘도 좋은 하루 보내세요.",
        "어르신 안녕하세요. 오늘 날씨가 어떤가요?",
        "안녕하세요, 오늘 하루 잘 지내셨나요?",
        "안녕하세요 어르신! 저 하루예요. 전화 주셔서 정말 기뻐요.",
        "어르신 안녕하세요. 하루에요. 오늘 기분은 어떠세요?",
        "안녕하세요, 오늘 하루 잘 보내고 계신가요?",
        "안녕하세요 어르신! 항상 행복하세요.",
        "어르신 안녕하세요. 하루입니다. 오늘도 힘차게 시작하세요.",
        "안녕하세요, 오늘 하루 어떠셨는지 궁금해요.",
        "안녕하세요 어르신! 하루에요. 오늘도 열심히 보내세요.",
    ...
    if 0 <= hour < 6:
        ...
        time_specific_messages = [
            ...
            "안녕하세요, 하루입니다. 이 새벽에 전화 주셔서 놀랐어요. 잘 주무시고 계셨나요?",
            "어르신, 새벽인데 건강은 어떠세요?",
            "안녕하세요, 새벽에 전화 주셨네요. 편하게 주무시고 계셨나요?"
        ]
    elif 6 <= hour < 12:
        # 아침 (6-12시)
        time_specific_messages = [
            "아침부터 전화 주셔서 정말 기뻐요! 저 하루에요!",
            "안녕하세요 어르신, 하루입니다. 좋은 아침이에요!",
            "아침부터 연락 주셔서 반가워요. 하루예요. 잘 주무셨어요?",
            "안녕하세요, 좋은 아침이네요. 오늘 하루도 기운차게 시작하시는군요!",
            "어르신, 저 하루에요. 아침부터 전화 주셔서 정말 기쁩니다!",
            "안녕하세요, 아침인데 잘 주무셨어요?",
            "좋은 아침이에요, 어르신! 하루입니다. 아침 식사는 하셨어요?",
            "안녕하세요, 아침부터 연락 주셔서 정말 반가워요."
        ]
    elif 12 <= hour < 18:
        # 오후 (12-18시)
        time_specific_messages = [
            "안녕하세요 어르신, 하루에요. 좋은 오후네요!",
            "안녕하세요, 오후에 전화 주셔서 반가워요.",
            "어르신, 저 하루입니다. 점심은 드셨어요? 좋은 오후 보내고 계신가요?",
            "안녕하세요, 하루에요. 오후 시간에 연락 주셨네요. 어떻게 지내세요?",
            "좋은 오후예요, 어르신! 오늘 하루 잘 보내고 계세요?",
            "안녕하세요, 오후인데 오늘은 어떻게 지내셨어요?",
            "어르신, 하루예요. 오후에 전화 주셔서 기뻐요. 건강은 어떠세요?",
        ...
        time_specific_messages = [
            ...
            "어르신, 저녁 시간에 전화 주셔서 반가워요. 저녁 드셨어요?",
            "안녕하세요, 저 하루입니다. 저녁인데 오늘 하루 잘 보내셨어요?",
            "저녁인데 식사는 하셨나요, 어르신?",
            "안녕하세요, 하루예요. 좋은 저녁이에요. 저녁은 드셨어요?",
            "어르신, 저 하루에요. 저녁 시간에 연락 주셨네요. 저녁 식사는 하셨어요?",
            "안녕하세요, 저녁인데 오늘 하루 어떠셨어요?",
            "저녁에 전화 주셔서 기뻐요. 하루입니다. 식사는 드셨나요?",
            "안녕하세요 어르신, 저녁 시간에 전화 주셨네요. 저녁은 드셨어요?",
        ...
        time_specific_messages = [
            ...
            "어르신, 밤 시간에 전화 주셨네요. 잘 주무시고 계셨나요?",
            "안녕하세요, 저 하루입니다. 밤인데 건강은 어떠세요?",
            "밤에 연락 주셔서 반가워요. 오늘 하루 잘 보내셨어요?",
            "안녕하세요, 하루예요. 좋은 밤이네요. 내일도 좋은 하루 되세요.",
            "어르신, 밤인데 오늘 하루 어떠셨어요?",
            "밤 시간에 전화 주셔서 기뻐요. 하루에요. 편하게 주무시고 계셨나요?"
        ]
